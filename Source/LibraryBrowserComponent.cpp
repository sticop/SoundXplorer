    ...
    : library (lib), folderModel (lib)
{
    ...
    analysisLabel.setFont (juce::Font (11.0f));
    analysisLabel.setColour (juce::Label::textColourId, juce::Colour (SoundXplorerLookAndFeel::accentOrange));
    addAndMakeVisible (analysisLabel);
    updateFolderList();
    
    // Sort label
    sortLabel.setText ("Name (ASC)", juce::dontSendNotification);
    sortLabel.setFont (juce::Font (11.0f));
    sortLabel.setColour (juce::Label::textColourId, juce::Colour (SoundXplorerLookAndFeel::textSecondary));
                                                                  ...
                                                                  int width, int height, bool rowIsSelected)
{
    ...
    // Folder icon
    g.setColour (juce::Colour (SoundXplorerLookAndFeel::accentBlue));
    g.setFont (juce::Font (12.0f));
    g.drawText (juce::CharPointer_UTF8("\xf0\x9f\x93\x81"), 4, 0, 20, height, juce::Justification::centredLeft);
